  ...
  return (
    <TableHead style={{
      ...
      <TableRow sx={{
        ...
        <TableCell sx={{ ...tableStyling, width: '4%', borderLeft: "1px solid white" }} align="left">
          Fecha Vencimiento
          <TableSortLabel
            active={orderBy === "nombre"}
            direction={orderBy === "nombre" ? order : 'asc'}
...
//modal--->
  ...
  const [elemento, setElemento] = useState({});
   const mostrarElemento = (token:any) => {
      // return(
      //   <ModalPersonalized2 elemento={elemento}/>
      // )
      setElemento({token:token})
      handleOpenModal()
   }

   //const mostrar: Element = Element();
                ...
                return (
                  <TableRow key={index}>
                    ...
                    <TableCell
                      ...
                      align="left"
                    >
                      <Button sx={{ fontSize: 20,color: '#42A5F5' }} onClick={()=>mostrarElemento(row.token)}><ImEye/></Button>
