...
const Demo = () => {
  ...
  const originalRows = [
    { name: "3-Bebidas calientes con café", calories: 200, fat: 6.0, carbs: 24, protein: 4.0 },
      ...
      <Paper>
        ...
        <TableContainer>
          <Table sx={{ tableLayout: "auto" }} aria-label="simple table">
            <TableHead>
              <TableRow>
                <TableCell style={{width:220}}>Grupo</TableCell>
                <TableCell style={{width:120}} align="right">Nombre</TableCell>
                <TableCell align="right">Opcional</TableCell>
                <TableCell align="right">Precio</TableCell>
                <TableCell align="right">Opcion visuala</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {rows.map((row) => (
