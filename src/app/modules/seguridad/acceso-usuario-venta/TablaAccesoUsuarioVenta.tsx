...
export default function TablaAccesoUsuarioVenta(props: any) {

  //console.log("props ", props);
  console.log("step 2 ", props.rows)
  const { rows } = props
  //checkInactivo
          ...
          >
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
              ...
              {/*valHead == true ?
                ...
                }} onClick={() => console.log("valor de ini ", inactivo_parent_act)}
                >
                ...
                <CardActionArea sx={{
                  padding: '0', margin: '0', marginTop: '3px', width: '42px',
                }} onClick={() => console.log("valor de ini333 ", inactivo_parent_act)}
                >
                  <LockOpenRoundedIcon />
                </CardActionArea>*/}
            </FormGroup>
