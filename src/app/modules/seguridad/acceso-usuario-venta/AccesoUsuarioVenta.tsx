...
//import TablaAccesoUsuarioVenta from './TablaAccesoUsuarioVenta';
...
import TablaAccesoUsuarioVenta from './TablaAccesoUsuarioVenta';
import PaletaParentUsuarioVenta from './PaletaParentUsuarioVenta';
...
const AccesoUsuarioVenta = () => {
    ...
    <>
      ...
      >
        ...
        <Typography variant="subtitle1" gutterBottom sx={{
          ...
          Acceso de Usuarios - Sistema de Ventas
   ...
   */}
      ...
      <br />
      <PaletaParentUsuarioVenta name="Sucursales" color="#EF9A9A" COLOR_R="239" COLOR_G="154" COLOR_B="154"
        rows={dataSucursalesJson}
      />
      <PaletaParentUsuarioVenta name="Pedidos Ya" color="#EF9A9A" COLOR_R="239" COLOR_G="154" COLOR_B="154"
        rows={dataSucursalesJson}
      />

      <PaletaParentUsuarioVenta name="Yaigo" color="#EF9A9A" COLOR_R="239" COLOR_G="154" COLOR_B="154"
        rows={dataSucursalesJson}
      />

      <PaletaParentUsuarioVenta name="test" color="#EF9A9A" COLOR_R="239" COLOR_G="154" COLOR_B="154"
        rows={dataSucursalesJson}
      />
...
export default AccesoUsuarioVenta