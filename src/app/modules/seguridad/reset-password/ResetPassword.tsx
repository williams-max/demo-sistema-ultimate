...
import { Typography, TextField, Button, InputAdornment, Box, Divider, MenuItem } from '@mui/material';
        ...
        <form style={{ marginTop: '1%' }}>
          ...
          <Box sx={{
            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', marginBottom: '10px' }}>
              <ColorButtonGreen variant="contained" sx={{ marginTop: '34px' }}>Enviar</ColorButtonGreen>
